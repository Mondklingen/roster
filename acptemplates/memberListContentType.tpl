<dl>
    ...
    <dd>
        ...
        <fieldset class="member-bg-images">
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==1}checked{/if}{/if} id="picture_1" name="contentData[picture]" value="1"><label for="picture_1"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg1.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==2}checked{/if}{/if} id="picture_2" name="contentData[picture]" value="2"><label for="picture_2"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg2.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==3}checked{/if}{/if} id="picture_3" name="contentData[picture]" value="3"><label for="picture_3"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg3.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==4}checked{/if}{/if} id="picture_4" name="contentData[picture]" value="4"><label for="picture_4"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg4.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==5}checked{/if}{/if} id="picture_5" name="contentData[picture]" value="5"><label for="picture_5"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg5.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==6}checked{/if}{/if} id="picture_6" name="contentData[picture]" value="6"><label for="picture_6"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg6.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==7}checked{/if}{/if} id="picture_7" name="contentData[picture]" value="7"><label for="picture_7"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg7.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==8}checked{/if}{/if} id="picture_8" name="contentData[picture]" value="8"><label for="picture_8"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg8.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==9}checked{/if}{/if} id="picture_9" name="contentData[picture]" value="9"><label for="picture_9"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg9.png"></label>
            <input type="radio" {if $contentData['picture']|isset}{if $contentData['picture']==10}checked{/if}{/if} id="picture_10" name="contentData[picture]" value="10"><label for="picture_10"> <img src="{@$__wcf->getPath('cms')}/images/wowrooster/background/bg10.png"></label>
        </fieldset>
